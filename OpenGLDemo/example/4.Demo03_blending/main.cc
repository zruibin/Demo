...
void discardBlending(GLFWwindow* window); //丢弃片段
void sortedBlending(GLFWwindow* window); //渲染半透明纹理
...
int main()
{
    ...
    //丢弃片段
    //discardBlending(window);
    
    //渲染半透明纹理
    sortedBlending(window);
...
void discardBlending(GLFWwindow* window)
{
    // configure global opengl state
    glEnable(GL_DEPTH_TEST);

     // build and compile shaders
    Shader shader(vShaderSource, discardFShaderSource);
...
void sortedBlending(GLFWwindow* window)
{
    // configure global opengl state
    glEnable(GL_DEPTH_TEST);
    glEnable(GL_BLEND);
    ...
    // build and compile shaders
    Shader shader(vShaderSource, sortedFShaderSource);
